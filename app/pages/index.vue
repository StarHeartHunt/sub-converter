...
const configPresets = [
  { label: "None", value: NONE_CONFIG },
  { label: "ACL4SSR Online", value: "ACL4SSR_Online" },
  { label: "ACL4SSR Online Full", value: "ACL4SSR_Online_Full" },
  { label: "ACL4SSR Online Mini", value: "ACL4SSR_Online_Mini" },
  { label: "ACL4SSR Online NoAuto", value: "ACL4SSR_Online_NoAuto" },
  { label: "ACL4SSR Online Full NoAuto", value: "ACL4SSR_Online_Full_NoAuto" },
  { label: "ACL4SSR Online Mini NoAuto", value: "ACL4SSR_Online_Mini_NoAuto" },
  { label: "ACL4SSR Online AdblockPlus", value: "ACL4SSR_Online_AdblockPlus" },
  {
    label: "ACL4SSR Online Full AdblockPlus",
    value: "ACL4SSR_Online_Full_AdblockPlus",
  },
  {
    label: "ACL4SSR Online Full MultiMode",
    value: "ACL4SSR_Online_Full_MultiMode",
  },
  {
    label: "ACL4SSR Online Mini MultiMode",
    value: "ACL4SSR_Online_Mini_MultiMode",
  },
  {
    label: "ACL4SSR Online MultiCountry",
    value: "ACL4SSR_Online_MultiCountry",
  },
  {
    label: "ACL4SSR Online Mini MultiCountry",
    value: "ACL4SSR_Online_Mini_MultiCountry",
  },
  { label: "ACL4SSR Online NoReject", value: "ACL4SSR_Online_NoReject" },
  {
    label: "ACL4SSR Online Full Netflix",
    value: "ACL4SSR_Online_Full_Netflix",
  },
  { label: "ACL4SSR Online Full Google", value: "ACL4SSR_Online_Full_Google" },
  {
    label: "ACL4SSR Online Mini Fallback",
    value: "ACL4SSR_Online_Mini_Fallback",
  },
];
...
function generateUrl() {
  ...
  if (remoteConfig.value && remoteConfig.value !== NONE_CONFIG)
    params.set("config", remoteConfig.value);
...
function importToClash() {
  if (!resultUrl.value) return;
  window.open(
    `clash://install-config?url=${encodeURIComponent(resultUrl.value)}`,
  );
}
  ...
  <div class="min-h-screen bg-muted">
    ...
    <div class="mx-auto max-w-2xl px-4 pb-12">
      <UCard>
        ...
        <!-- Client -->
        <UFormField label="客户端" class="mb-4">
          <USelect v-model="clientType" :items="clients" class="w-full" />
        </UFormField>

        <!-- Remote Config -->
        <UFormField label="远程配置" class="mb-4">
          <USelect
        ...
        <template v-if="isAdvanced">
          ...
          <UFormField label="包含节点" class="mb-4">
            <UInput
              v-model="includeRemarks"
              placeholder="正则"
              class="w-full"
            />
          </UFormField>
          <UFormField label="排除节点" class="mb-4">
            <UInput
              v-model="excludeRemarks"
              placeholder="正则"
              class="w-full"
            />
          </UFormField>
          ...
          <UFormField label="输出文件名" class="mb-5">
            <UInput v-model="filename" placeholder="可选" class="w-full" />
          </UFormField>
        ...
        <div class="flex gap-3 mt-6">
          <UButton color="primary" @click="generateUrl"> 生成订阅链接 </UButton>
